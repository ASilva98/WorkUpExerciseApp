...
import 'update_height_model.dart';
export 'update_height_model.dart';

class UpdateHeightWidget extends StatefulWidget {
  const UpdateHeightWidget({super.key});

  @override
  State<UpdateHeightWidget> createState() => _UpdateHeightWidgetState();
}

class _UpdateHeightWidgetState extends State<UpdateHeightWidget> {
  late UpdateHeightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateHeightModel());
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await currentUserReference!
                              ...
                              heightFeet: int.tryParse(
                                  _model.weightInputTextController1.text),
                              heightInches: int.tryParse(
