...
import 'fitness_calculations_model.dart';
export 'fitness_calculations_model.dart';

class FitnessCalculationsWidget extends StatefulWidget {
  const FitnessCalculationsWidget({super.key});

  @override
  State<FitnessCalculationsWidget> createState() =>
      _FitnessCalculationsWidgetState();
}

class _FitnessCalculationsWidgetState extends State<FitnessCalculationsWidget> {
  late FitnessCalculationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FitnessCalculationsModel());
  }
